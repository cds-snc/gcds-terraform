...
inputs = {
  ...
  domain_cdn                = "${local.vars.inputs.alpha_domain_cdn}"
  domain_website_en         = "${local.vars.inputs.alpha_domain_website_en}"
  domain_website_fr         = "${local.vars.inputs.alpha_domain_website_fr}"
