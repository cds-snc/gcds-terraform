...
resource "aws_route53_record" "website_alpha_dns_validation_en" {
...
resource "aws_route53_record" "website_alpha_dns_validation_fr" {
...
resource "aws_acm_certificate_validation" "website_alpha_validation_en" {
  provider                = aws.us-east-1
  certificate_arn         = aws_acm_certificate.website_alpha_en.arn
  validation_record_fqdns = [for record in aws_route53_record.website_alpha_dns_validation_en : record.fqdn]
}
